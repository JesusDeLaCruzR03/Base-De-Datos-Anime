...
public class Aplicacion extends Application {
    ...
    private static final String INTERFAZ_ANIME_FXML =
        "fxml/interfaz-anime.fxml";
    ...
    @Override public void start(Stage escenario) throws Exception {
        ...
        escenario.setTitle("Administrador de Animes");

        FXMLLoader cargador;
        cargador = new FXMLLoader(cl.getResource(INTERFAZ_ANIME_FXML));
        BorderPane cristal = (BorderPane)cargador.load();
        ControladorInterfazAnime controlador = cargador.getController();
